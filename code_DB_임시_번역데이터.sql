...
VALUES
    ...
    ('boolean', '{"Java": "불리언", "Python": "불리언", "JavaScript": "불리언", "CSharp "불리언", "CPlusPlus": "불리언", "C": "불리언", "TypeScript": "불리언", "Kotlin": "불리언", "Ruby": "불리언", "PHP": "불리언"}'),
    ('break', '{"Java": "중단", "Python": "중단", "JavaScript": "중단", "CSharp": "중단", "CPlusPlus": "중단", "C": "중단", "TypeScript": "중단", "Kotlin": "중단", "Ruby": "중단", "PHP": "중단"}'),
    ('byte', '{"Java": "바이트", "Python": "바이트", "JavaScript": "바이트", "CSharp": "바이트", "CPlusPlus": "바이트", "C": "바이트", "TypeScript": "바이트", "Kotlin": "바이트", "Ruby": "바이트", "PHP": "바이트"}'),
    ...
    ('char', '{"Java": "문자", "Python": "문자", "JavaScript": "문자", "CSharp": "문자", "CPlusPlus": "문자", "C": "문자", "TypeScript": "문자", "Kotlin": "문자", "Ruby": "문자", "PHP": "문자"}'),
    ('class', '{"Java": "클래스", "Python": "클래스", "JavaScript": "클래스", "CSharp": "클래스", "CPlusPlus": "클래스", "C": "클래스", "TypeScript": "클래스", "Kotlin": "클래스", "Ruby": "클래스", "PHP": "클래스"}'),
    ('const', '{"Java": "상수", "Python": "상수", "JavaScript": "상수", "CSharp": "상수", "CPlusPlus": "상수", "C": "상수", "TypeScript": "상수", "Kotlin": "상수", "Ruby": "상수", "PHP": "상수"}'),
    ...
    ('double', '{"Java": "실수형", "Python": "실수형", "JavaScript": "실수형", "CSharp": "실수형", "CPlusPlus": "실수형", "C": "실수형", "TypeScript": "실수형", "Kotlin": "실수형", "Ruby": "실수형", "PHP": "실수형"}'),
...
VALUES
    ...
    ('long', '{"Java": "긴 정수", "Python": "긴 정수", "JavaScript": "긴 정수", "CSharp": "긴 정수", "CPlusPlus": "긴 정수", "C": "긴 정수", "TypeScript": "긴 정수", "Kotlin": "긴 정수", "Ruby": "긴 정수", "PHP": "긴 정수"}'),
    ...
    ('null', '{"Java": "널", "Python": "널", "JavaScript": "널", "CSharp": "널", "CPlusPlus": "널", "C": "널", "TypeScript": "널", "Kotlin": "널", "Ruby": "널", "PHP": "널"}'),
    ...
    ('short', '{"Java": "짧은 정수", "Python": "짧은 정수", "JavaScript": "짧은 정수", "CSharp": "짧은 정수", "CPlusPlus": "짧은 정수", "C": "짧은 정수", "TypeScript": "짧은 정수", "Kotlin": "짧은 정수", "Ruby": "짧은 정수", "PHP": "짧은 정수"}'),
    ('static', '{"Java": "정적", "Python": "정적", "JavaScript": "정적", "CSharp": "정적", "CPlusPlus": "정적", "C": "정적", "TypeScript": "정적", "Kotlin": "정적", "Ruby": "정적", "PHP": "정적"}'),
    ('strictfp', '{"Java": "엄격한 부동 소수점", "Python": "엄격한 부동 소수점", "JavaScript": "엄격한 부동 소수점", "CSharp": "엄격한 부동 소수점", "CPlusPlus": "엄격한 부동 소수점", "C": "엄격한 부동 소수점", "TypeScript": "엄격한 부동 소수점", "Kotlin": "엄격한 부동 소수점", "Ruby": "엄격한 부동 소수점", "PHP": "엄격한 부동 소수점"}'),
    ('super', '{"Java": "상위", "Python": "상위", "JavaScript": "상위", "CSharp": "상위", "CPlusPlus": "상위", "C": "상위", "TypeScript": "상위", "Kotlin": "상위", "Ruby": "상위", "PHP": "상위"}'),
    ('switch', '{"Java": "조건 분기", "Python": "조건 분기", "JavaScript": "조건 분기", "CSharp": "조건 분기", "CPlusPlus": "조건 분기", "C": "조건 분기", "TypeScript": "조건 분기", "Kotlin": "조건 분기", "Ruby": "조건 분기", "PHP": "조건 분기"}'),
...
VALUES
    ...
    ('while', '{"Java": "조건 반복", "Python": "조건 반복", "JavaScript": "조건 반복", "CSharp": "조건 반복", "CPlusPlus": "조건 반복", "C": "조건 반복", "TypeScript": "조건 반복", "Kotlin": "조건 반복", "Ruby": "조건 반복", "PHP": "조건 반복"}'),
    ('System.out.println', '{"Java": "표준 출력", "Python": "출력", "JavaScript": "출력", "CSharp": "출력", "CPlusPlus": "출력", "C": "출력", "TypeScript": "출력", "Kotlin": "출력", "Ruby": "출력", "PHP": "출력"}'),
    ...
    ('pow', '{"Java": "거듭제곱", "Python": "거듭제곱", "JavaScript": "거듭제곱", "CSharp": "거듭제곱", "CPlusPlus": "거듭제곱", "C": "거듭제곱", "TypeScript": "거듭제곱", "Kotlin": "거듭제곱", "Ruby": "거듭제곱", "PHP": "거듭제곱"}'),
